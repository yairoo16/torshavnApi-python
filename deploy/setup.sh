...
PROJECT_GIT_URL='https://github.com/yairoo16/torshavnApi-python.git'
...
# Configure nginx
cp $PROJECT_BASE_PATH/deploy/nginx_torshavn_api.conf /etc/nginx/sites-available/torshavn_api.conf
rm /etc/nginx/sites-enabled/default
ln -s /etc/nginx/sites-available/torshavn_api.conf /etc/nginx/sites-enabled/torshavn_api.conf
